...
import { MdFastfood, MdCloudUpload, MdDelete, MdFoodBank, MdAttachMoney, MdMoney, MdMoneyOff, MdCurrencyRupee } from "react-icons/md";
    ...
    <div className='w-full min-h-screen flex items-center justify-center'>
      <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
          ...
          <div className="w-full flex flex-col md:flex-row items-center gap-3">
            ...
            <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2"><MdCurrencyRupee className='text-gray-700 text-2xl'/>
                    <input 
                      type="text" 
                      required
                      value={price}
          ...
          <div className="flex items-center w-full ">
            <button 
              type='button' 
              className='ml-0 md:ml-auto w-full md:w-auto border-none outline-none bg-emerald-500 px-12 py2 rounded-lg text-lg text-white font-semibold' onClick={saveDetails}>Save</button>
          </div>
      </div>
    </div>
  );
